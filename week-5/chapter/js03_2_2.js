 ...
 */
  ...
  //Event listener to run addWeekDays() function after page loads
  ...
  // Event listener to run showGames() function after page loads
  ...
  function showGames() {
    for (let i = 0; i < gameDates.length; i++) {
      ...
      // Display innings played for suspended, shortended, or extrainning games
      if (gameInnings[i] < 5) {
